-- TODO: keymaps should be in a map to export from this module
--  this would make it easier to reuse keymaps for other plugins

-- NOTE: some keymaps are in the plugin config files, since
--  they may require some particular configuration

-- create a command for last buffer swapping
vim.api.nvim_create_user_command('LastBufferSwap', require('user.core.utils').last_buffer_swap, {})
...
km.set('n', '<cr>', '<cmd>noh<cr><cr>', opts)
